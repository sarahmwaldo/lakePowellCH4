...
lakePowellData10<-read.csv(paste(myWD, "input/dataEntryQC.csv", sep="/"), #omitted two chamber deployments when the fan wasn't on
                         header=TRUE,
                         colClasses=c(rep("character",1), "numeric", "numeric", "character", "character", "integer"))
...
lakePowellData10$endTime<-lakePowellData10$RDateTime+(60*12)  #chamber deployments were nominally 10 minutes; breaking them into 3-min chunks
